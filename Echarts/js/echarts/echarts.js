...
define(function (require) {
    ...
    Echarts.prototype = {
        ...
        _init: function () {
            ...
            // 内置图表
            // 孤岛
            var Island = require('echarts/chart/island');
            this._island = new Island(this._themeConfig, this._messageCenter, _zr, {}, this);
            this.chart.island = this._island;

            // 内置通用组件
            // 工具箱
            var Toolbox = require('echarts/component/toolbox');
            this._toolbox = new Toolbox(this._themeConfig, this._messageCenter, _zr, {}, this);
            this.component.toolbox = this._toolbox;

            var componentLibrary = require('echarts/component');
            componentLibrary.define('title', require('echarts/component/title'));
            componentLibrary.define('tooltip', require('echarts/component/tooltip'));
            componentLibrary.define('legend', require('echarts/component/legend'));
        ...
        _render: function (magicOption) {
            ...
            var chartLibrary = require('echarts/chart');
            var componentLibrary = require('echarts/component');
        ...
        _setTimelineOption: function(option) {
            ...
            var Timeline = require('echarts/component/timeline');
               ...
               if (typeof theme === 'string') {
                    ...
                    switch (theme) {
                        case 'macarons':
                            ...
                            break;
                        case 'infographic':
                            theme = require('echarts/theme/infographic');
                            break;
                        default:
                            theme = {}; // require('echarts/theme/default');
                    }
                }
                else {
                    theme = theme || {};
